      ...
      <div className="space-y-20">
        <ServiceSection title="Massages">
          ...
          <Appearance
            ...
            event="Introduced in the late 1800s"
            cta="Book now"
          />
        </ServiceSection>
        <ServiceSection title="Ayurveda">
          <Appearance
            ...
            event="Get started, understand your Dosha"
            cta="Schedule now"
          />
          <Appearance
            href="#"
          ...
          <Appearance
            ...
            event="Ancient systems of healing"
            cta="Schedule now"
          />
        </ServiceSection>
        <ServiceSection title="Astrology">
          <Appearance
            ...
            event="Learn about your birth chart"
            cta="Select a time"
          />
          <Appearance
            href="#"
          ...
          <Appearance
            ...
            event="How to live in Cosmic Harmony"
            cta="Select a time"
          />
        </ServiceSection>
      </div>
